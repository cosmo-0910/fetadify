      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm text-muted-foreground">
            ...
            <li><a href="#services" className="hover:text-primary transition-colors">AI Blockchain</a></li>
            <li><a href="#services" className="hover:text-primary transition-colors">AI Data Analytics</a></li>
          </ul>
        </div>
